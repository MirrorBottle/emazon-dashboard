new class User {
	constructor() {
        ...
        this.userProfileButton = $('#userProfile')[0];
        this.userEditButton = $('#userEdit')[0];

        this.userProfileButton.addEventListener('click', this.setToProfileView.bind(this));
        this.userEditButton.addEventListener('click', this.setToEditView.bind(this));
	}
	...
	setToProfileView(e) {
		if (e.target.id === 'userProfile') {
            ...
            this.userEditButton.classList.remove('btn-primary');
            this.userEditButton.classList.add('btn-secondary');
    ...
    setToEditView(e) {
		if (e.target.id === 'userEdit') {
            ...
            this.userProfileButton.classList.remove('btn-primary');
            this.userProfileButton.classList.add('btn-secondary');
